    ...
    for file_name in pieces_files:
        ...
        if files_procesed < limit_files or limit_files == 0:
            ...
            if points:
                ...
                print("Max x y, Min x y:", (max_x, max_y), (min_x, min_y))
                ...
                print("Canvas size:", (canvas_size, canvas_size))
            ...
            while current_line < n_lines:
                ...
                if match_P9102:
                    ...
                    if len(coordinates) >= 2:
                        ...
                        cv2.line(image, (int(x1), int(y1)), (int(x2), int(y2)), free_line[0], free_line[1])
                        cv2.circle(image, (int(x2), int(y2)), 2, prircing_dot[0], prircing_dot[1])
