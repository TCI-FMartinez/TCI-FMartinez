...
def DiscretizaArco (X_start, Y_start, X_end, Y_end, I, J, N = 10, horario = True) -> list:
    ...
    if theta_end < theta_start and not horario:
        theta_end += 2 * np.pi
        delta_theta = (theta_start - theta_end) / N
...
if __name__ == "__main__":
    ...
    escala = 1
    segmentos = 10
    x_ini, y_ini, x_fin, y_fin, I1, J1 = 10, 4.75, 4.75, 10, 0, 5.25
    
    
    segmentos_G3 = DiscretizaArco(x_ini, y_ini, x_fin, y_fin, I1, J1, segmentos, False)
    ...
    image = cv2.line(image,  (5, 5), (10, 5), (0,0,250), 1)
    ...
    image = cv2.line(image,  (5, 10), (5, 50), (0,0,250), 1)            
