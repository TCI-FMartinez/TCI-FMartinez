...
def draw_contours(
    ...
    draw_bounding: bool = False,
    show_metrics: bool = True,
) -> bool:
    """Dibuja los contornos de las piezas a partir de archivos CNC y los guarda como imágenes PNG.
    asrgs:
        pieces_files: Lista de rutas a los archivos CNC de las piezas.
        output_filename: Ruta del archivo PNG de salida (si se proporciona y solo hay un archivo
                         CNC). Si se proporcionan múltiples archivos CNC, se ignorará este parámetro y se generarán archivos separados.
                         out_WH: Dimensiones (ancho, alto) de la imagen PNG de salida.
                         N: Número de segmentos para aproximar arcos.
                         out_path: Directorio donde se guardarán las imágenes PNG generadas (si se generan múltiples archivos).
                         auto_close_open: Si es True, se cerrarán automáticamente los contornos abiertos.
                         draw_bounding: Si es True, se dibujará un rectángulo delimitador alrededor de los contornos.
                         show_metrics: Si es True, se mostrarán métricas como el área, peso, material, etc. en la imagen.
    returns:
        True si al menos una imagen se guardó correctamente, False en caso contrario."""
